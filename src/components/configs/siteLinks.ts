export const _cfgSite = {
  ...
  title_ja: "ビル経営ゲーム",
  description:
    "Scratch Building is a game developed on the Scratch platform, and this site functions as its official website. It offers various features such as account authentication, comments, notifications, and community participation.",
  description_ja:
...
export const _cfgSiteLinks = {
  ...
  docs_terms_of_use:
    "https://scratch-building-docs.vercel.app/ja/docs/terms-of-use",
  docs_guidelines:
    "https://scratch-building-docs.vercel.app/ja/docs/guidelines",
};
