        ...
        <>
            <header className={`fixed inset-x-0 top-4 z-[49] flex justify-between items-center gap-4 rounded-lg backdrop-blur-md border-[1px] border-neutral-500/50 text-white bg-black/50 dark:bg-white/10 w-[95%] max-w-7xl m-auto h-[50px] px-4 py-2 animate-fade-down animate-once animate-duration-350 animate-delay-0 animate-ease-in-out animate-normal animate-fill-forwards`}>
                ...
                <div className="hidden md:block h-[30px]">
                    <MyAccount userData={userData} username={username} user_image={user_image}/>
                </div>
...
export function MyAccount({ userData, username, user_image }: { userData: any, username: string, user_image: string }) {
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 select-none">
                ...
                <DropdownMenuGroup>
                    ...
                    <>
                        ...
                        <Link href={`https://scratch.mit.edu/accounts/settings/`} target="_block">
                            <DropdownMenuItem>
