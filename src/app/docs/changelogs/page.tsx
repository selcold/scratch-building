...
import { ContentGET_changelogs, ContentsSET } from "@/components/frontend/elements/contents";
...
export default function Home() {
	...
	// headカスタム
	const Head_config = {
		title: `${_locales('changelogs')} | ${_locales(_cfgSite.title)}`,
	};
					...
					Breadcrumb={
						<Breadcrumb>
							<BreadcrumbList>
								...
								<BreadcrumbSeparator />
								<BreadcrumbItem>
									<BreadcrumbPage>{_locales('changelogs')}</BreadcrumbPage>
								</BreadcrumbItem>
							</BreadcrumbList>
						</Breadcrumb>
					}
