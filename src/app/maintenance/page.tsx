...
import { formatDateTime } from "@/components/client/site/formatDateTime";
                ...
                <CardContent>
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                      <AccordionTrigger>
                        {_locales("Why am I seeing this page?")}
                      </AccordionTrigger>
                      <AccordionContent>
                        {_locales(
                    ...
                    <AccordionItem value="item-2">
                      <AccordionTrigger>
                        {_locales("When will maintenance be completed?")}
                      </AccordionTrigger>
                      <AccordionContent>
                        {_locales(
                    ...
                    <HoverCardContent className="w-80">
                      <div className="flex justify-between space-x-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-sm">
                            Feel free to explore our projects and contribute to
                            our community.
                          </p>
